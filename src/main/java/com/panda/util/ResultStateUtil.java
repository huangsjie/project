...
public class ResultStateUtil {
    ...
    public static final String ERROR_DATABASE_OPERATION = "遇到一些问题, sql执行错误.";//002
    ...
    public static final String FALL_LONGITUDE_INITIALIZATION = "经纬度匹配城市失败,请重新获取正确的经纬度！";//108
