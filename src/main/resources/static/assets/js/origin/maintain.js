var maintain = function () {
    ...
    var status = {
        0: {'title': '待检修', 'class': ' m-badge--warning'},
        1: {'title': '完成', 'class': ' m-badge--success'},
        2: {'title': '待检修', 'class': ' m-badge--warning'}
    };
    /**
     * 获取列表数据
     */
        ...
        $( "#maintainEdit_edit_form" ).validate({
            ...
            submitHandler: function (form){
                ...
                request(
                    ...
                    function(result){
                        if(result.message){
                            blockUiClose('.maintainEditModal .modal-content',1,".close-parent",0);
    ...
    var removeValue = function(type){
        ...
        $(".maintainEditModal [name='unitName']").val("").attr("disabled",false)
        $(".maintainEditModal [name='unitUsage']").val("").attr("disabled",false)
        $(".maintainEditModal [name='unitType']").val("").attr("disabled",false)
        $(".maintainEditModal [name='unitNo']").val("").attr("disabled",false)
        $(".maintainEditModal [name='unitCycle']").val("").attr("disabled",false)
        $(".maintainEditModal [name='status']").val(2)
        $(".maintainEditModal [name='description']").val("")
        $(".maintainEditModal [name='unitClear']").val("")
